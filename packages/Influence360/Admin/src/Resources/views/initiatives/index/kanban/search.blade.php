{!! view_render_event('admin.initiatives.index.kanban.search.before') !!}
...
{!! view_render_event('admin.initiatives.index.kanban.search.after') !!}
    ...
    >
        <div class="relative flex max-w-[445px] items-center max-sm:w-full max-sm:max-w-full">
            ...
            <input
                type="text"
                name="search"
                class="block w-full rounded-lg border bg-white py-1.5 initiativeing-6 text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400 dark:focus:border-gray-400 ltr:pl-10 ltr:pr-3 rtl:pl-3 rtl:pr-10"
                placeholder="@lang('admin::app.initiatives.index.kanban.toolbar.search.title')"
                autocomplete="off"
