{!! view_render_event('admin.initiatives.index.kanban.filter.before') !!}
...
{!! view_render_event('admin.initiatives.index.kanban.filter.after') !!}
...
@pushOnce('scripts')
    ...
    >
        {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.before') !!}
        ...
        >
            <!-- Drawer Toggler -->
            <x-slot:toggle>
                {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.toggle_button.before') !!}
                ...
                <div class="relative flex cursor-pointer items-center rounded-md bg-sky-100 px-4 py-[9px] font-semibold text-sky-600 dark:bg-brandColor dark:text-white">
                    @lang('admin::app.initiatives.index.kanban.toolbar.filters.filter')
                ...
                {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.toggle_button.after') !!}
            </x-slot>

            <!-- Drawer Header -->
            <x-slot:header class="p-3.5">
                {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.header.title.before') !!}

                <div class="grid gap-3">
                    <div class="flex items-center justify-between">
                        <p class="text-xl font-semibold dark:text-white">
                            @lang('admin::app.initiatives.index.kanban.toolbar.filters.filters')
                        </p>
                    </div>
                </div>

                {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.header.title.after') !!}
            </x-slot>

            <!-- Drawer Content -->
            <x-slot:content>
                {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.content.before') !!}
                                ...
                                <template v-if="column.filterable_type === 'dropdown'">
                                    <div class="flex items-center justify-between">
                                        ...
                                        >
                                            ...
                                            >
                                                @lang('admin::app.initiatives.index.kanban.toolbar.filters.clear-all')
                                            </p>
                                        </div>
                                    </div>
                                            ...
                                            <x-slot:toggle>
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        ...
                                                        v-text="'@lang('admin::app.initiatives.index.kanban.toolbar.filters.select')'"
                                                    ...
                                                    <span
                                                        class="text-sm text-gray-400 dark:text-gray-400"
                                                        v-text="column.filterable_options.find((option => option.value === getAppliedColumnValues(column.index)))?.label ?? '@lang('admin::app.initiatives.index.kanban.toolbar.filters.select')'"
                                                        v-else
                                                    >
                                                    </span>
                ...
                {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.content.after') !!}
            </x-slot:content>

            <!-- Drawer Footer -->
            <x-slot:footer class="!pb-3">
                {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.footer.before') !!}
                ...
                <div class="flex justify-end gap-2 px-2 pt-3">
                    ...
                    <button
                        ...
                        @click="applyFilters"
                    >
                        @lang('admin::app.initiatives.index.kanban.toolbar.filters.apply-filters')
                    </button>
                </div>

                {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.footer.after') !!}
            </x-slot>
        </x-admin::drawer>

        {!! view_render_event('admin.initiatives.index.kanban.filter.drawer.after') !!}
    </script>
        ...
        app.component('v-kanban-searchable-dropdown', {
            ...
            methods: {
                lookUp($event) {
                    ...
                    this.$axios
                        .get('{{ route('admin.initiatives.kanban.look_up') }}', {
                            params
                        })
                        .then(({
                            data
