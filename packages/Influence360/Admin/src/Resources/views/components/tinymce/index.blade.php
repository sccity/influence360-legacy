@php($placeholders = app('\Influence360\Automation\Helpers\Entity')->getEmailTemplatePlaceholders())

<v-tinymce {{ $attributes }}></v-tinymce>

@pushOnce('scripts')
    <!--
        TODO (@devansh-influence360): Only this portion is pending; it just needs to be integrated using the Vite bundler. Currently,
