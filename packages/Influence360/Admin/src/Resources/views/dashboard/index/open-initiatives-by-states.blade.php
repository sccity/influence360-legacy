{!! view_render_event('admin.dashboard.index.open_initiatives_by_states.before') !!}

<!-- Total Initiatives Vue Component -->
<v-dashboard-open-initiatives-by-states>
    <!-- Shimmer -->
    <x-admin::shimmer.dashboard.index.open-initiatives-by-states />
</v-dashboard-open-initiatives-by-states>

{!! view_render_event('admin.dashboard.index.open_initiatives_by_states.after') !!}

@pushOnce('scripts')
    <script
        type="text/x-template"
        id="v-dashboard-open-initiatives--by-states-template"
    >
        <!-- Shimmer -->
            ...
            <div class="grid gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                <div class="flex flex-col justify-between gap-1">
                    <p class="text-base font-semibold dark:text-gray-300">
                        @lang('admin::app.dashboard.index.open-initiatives-by-states.title')
                    </p>
                </div>
                    ...
                    <div class="grid justify-center justify-items-center gap-3.5 py-2.5">
                        ...
                        <div class="flex flex-col items-center">
                            <p class="text-base font-semibold text-gray-400">
                                @lang('admin::app.dashboard.index.open-initiatives-by-states.empty-title')
                            </p>

                            <p class="text-gray-400">
                                @lang('admin::app.dashboard.index.open-initiatives-by-states.empty-info')
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script type="module">
        app.component('v-dashboard-open-initiatives-by-states', {
            template: '#v-dashboard-open-initiatives--by-states-template',
            ...
            methods: {
                getStats(filtets) {
                    ...
                    filtets.type = 'open-initiatives-by-states';
