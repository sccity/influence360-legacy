...
return [
        ...
        'layouts' => [
            'header' => [
                'mega-search' => [
                    ...
                    'explore-all-initiatives'             => 'کاوش در تمامی سرنخ‌ها',
                    ...
                    'explore-all-matching-initiatives'    => 'کاوش در تمامی سرنخ‌های مطابق ":query" (:count)',
    ...
    'quotes' => [
        ...
        'create' => [
            ...
            'link-to-initiative'      => 'پیوند به سرنخ',
    ...
    'settings' => [
        ...
        'workflows' => [
            ...
            'helpers' => [
                'update-related-initiatives'       => 'به‌روزرسانی سرنخ‌های مرتبط',
                ...
                'update-initiative'                => 'به‌روزرسانی سرنخ',
    ...
    'mail' => [
        ...
        'view' => [
            ...
            'search-an-existing-initiative'    => 'جستجوی سرنخ موجود',
            ...
            'description'                => 'توضیحات',
            'search'                     => 'جستجو...',
            'add-new-initiative'               => 'افزودن سرنخ جدید',
            'create-new-contact'         => 'ایجاد مخاطب جدید',
            'save-contact'               => 'ذخیره مخاطب',
            'create-initiative'                => 'ایجاد سرنخ',
            'linked-contact'             => 'مخاطب مرتبط',
            'link-to-contact'            => 'لینک به مخاطب',
            'link-to-initiative'               => 'لینک به سرنخ',
            'linked-initiative'                => 'سرنخ مرتبط',
            'initiative-details'               => 'جزئیات سرنخ',
    ...
    'initiatives' => [
        ...
        'index' => [
            ...
            'datagrid' => [
                ...
                'subject'             => 'موضوع',
                'source'              => 'منبع',
                'initiative-value'          => 'ارزش سرنخ',
                'initiative-type'           => 'نوع سرنخ',
                'tag-name'            => 'نام برچسب',
                'contact-person'      => 'شخص تماس',
                'stage'               => 'مرحله',
                'rotten-initiative'         => 'سرنخ خراب شده',
            ...
            'kanban' => [
                ...
                'create-initiative-btn'        => 'ایجاد سرنخ',
    ...
    'dashboard' => [
        'index' => [
            ...
            'over-all' => [
                'average-initiative-value'    => 'میانگین ارزش لید',
                'total-initiatives'           => 'کل لیدها',
                'average-initiatives-per-day' => 'میانگین لیدها در روز',
    ...
    'layouts' => [
        ...
        'initiative'                 => 'لید',
        'initiative-info'            => 'مدیریت همه تنظیمات مربوط به لیدها در CRM',
